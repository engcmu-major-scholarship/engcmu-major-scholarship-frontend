    ...
    <div className="h-full w-full flex flex-col overflow-y-auto">
      <div className="flex flex-col px-24 py-10 gap-6">
        <div className="inline-block">
          <label className="font-bold text-gray-800 mr-4">ชื่อ-นามสกุล</label>
          <input
            type="text"
            id="fname"
        ...
        <div className="inline-block">
          <label className="font-bold text-gray-800 mr-4">รหัสนักศึกษา</label>
          <input
            type="text"
            id="fname"
            name="fname inline-block"
        ...
        <div>
          <label className="font-bold text-gray-800">อาจารย์ที่ปรึกษา</label>
        </div>

        <div>
          <label className="font-bold text-gray-800">รูปบัตรนักศึกษา</label>
        ...
        <div>
          <label className="font-bold text-gray-800">รูปหน้าบัญชีธนาคาร</label>
          <div className="px-3 py-1 mt-4">
            <label
              htmlFor="file-upload"
              className="rounded px-5 py-2 mr-6 bg-[#DBE9EA] cursor-pointer hover:bg-[#B0D4D5]"
